databaseChangeLog = {
    ...
    changeSet(author: "nathan (generated)", id: "1461804602938-1") {
    ...
    changeSet(author: "nathan (generated)", id: "1461804602938-2") {
        addColumn(tableName: "quote") {
            column(name: "attribution_id", type: "bigint")
        }
    }

    changeSet(author: "nathan (generated)", id: "1461804602938-3") {
